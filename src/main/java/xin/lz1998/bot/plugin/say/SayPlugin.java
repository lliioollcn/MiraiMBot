...
public class SayPlugin extends CQPlugin {
    ...
    public int onPrivateMessage(CoolQ cq, CQPrivateMessageEvent event) {
        ...
        if (msg.startsWith("say")) {
            cq.sendPrivateMsg(user_id, msg.substring(3), true);
            cq.sendPrivateMsg(user_id, "[CQ:image,file=https://ci.codemc.io/buildStatus/icon?job=Mohist-Community%2FMohist-" + msg.substring(3) + "]", false);
        }
